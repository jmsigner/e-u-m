...
# 
# ```{r, echo = FALSE, fig.cap="Eigenes Foto"}
# #knitr::include_graphics(here::here("img/bsp_foto.JPG"))
# ```
# 
# 
# ----
# 
# - Oft sind Individuen nicht eindeutig erkennbar.
# - Es gibt Methoden, die damit umgehen können (z.B. das Random Encounter Model).
# - Das REM wird in der Regel für Kamerafotos verwendet.
# 
# 
# ---
# 
...
# mit
# 
# - $D$: Anzahl Individuen pro $km^2$
# - $y$: Anzahl Individuen auf Fotos
# - $t$: Stichprobenzeitraum in Tagen
# - **$\nu$: Bewegungsdistanz in km pro Tag**
# - $r$: Auslösedistanz in km
# - $\theta$: Auslösewinkel in Bogenmaß
# 
# In R gibt es das Paket `library(remBoot)`, um Konfidenzintervalle zu berechnen.
# 
# ----
# 
# - Eine Erweiterung zum REM ist das REST-Modell (Random Encounter and Staying Time).
# 
# - Eine gute Übersicht zu den unterschiedlichen Methoden gibt:  Iijima 2020 A Review of Wildlife Abundance Estimation Models: Comparison of Models for Correct Application (https://doi.org/10.3106/ms2019-0082).
# 
# <!----
# 
# ## Bis zur nächsten Woche
# 
# Lesen Sie (StudIP `lit/waltert2019.pdf`): 
# 
# ```{r, echo = FALSE, fig.cap="Eigenes Foto"}
# knitr::include_graphics(here::here("img/waltert2019.png"))
# ```
# 
# - Wie kommt es zu seinem Aufsatz?
# 
# ## Peer review
# 
# Und überlegen Sie sich Antworten zu Walters et al. 2019:
# 
# - Welche Art wurder untersucht und was war das Ziel der Studie?
# - Welche Methoden wurden zur Erfassung angewandt?
# - Welche Methoden wurden zur Analyse angewandt?
# - Wie wurden die Ergebnisse validiert?
# - Was habe ich nicht verstanden?
# 
# ## Wie kommt es zu so einer Veröffentlichung?
# 
# ```{r, echo = FALSE, fig.cap="Quelle: FOSTER (o. J.). Online-Kurs. Open Peer Review. https://www.fosteropenscience.eu/learning/open-peer-review"}
# knitr::include_graphics(here::here("img/peer_review.png"))
# ```
# 
# 
# ## Wer sollte als Koauthor/in angeführt werden?
# 
# Übernommen von: https://wissenschaftliche-integritaet.de/kommentare/kriterien-der-autorschaft-negativkatalog/
# 
...
# 
# ```{r, fig.cap="Von James Lindsey at Ecology of Commanster, CC BY-SA 3.0, https://commons.wikimedia.org/w/index.php?curid=1621649", echo = FALSE}
# knitr::include_graphics(here::here("img/gelbhalsmaus.jpg"))
# ```
# 
# ------------------------------------------------------------------------
# 
...
# ## Schnabel Schätzer
# 
# Bis jetzt haben wir zwei Fangereignisse herangezogen. Es wäre besser, wenn wir alle Daten verwenden. Dann kann z.B. der Schnabel Schätzer verwendet werden:
# 
# $$ \hat{N} = \frac{A}{B} $$
# 
# ------------------------------------------------------------------------
...
# -   $n_i$: Anzahl Individuen in der $i-\text{ten}$ Stichprobe.
# -   $m_i$: Anzahl markierte Individuen in der $i-\text{ten}$ Stichprobe.
# -   $u_i$: Anzahl nicht markierte Individuen in der $i-\text{ten}$ Stichprobe.
# -   $M_i$: Anzahl nicht markierter Individuen in allen vorherigen Fangereignissen: $\sum_{j=1}^{i-1} u_j$
# 
# ------------------------------------------------------------------------
# 
# ### Schnabel-Schätzer in R
# 
# ```{r}
# library(fishmethods)
# 
# n_i <- colSums(dat2 %>% dplyr::select(o1:o7))
# 
# detected_before <- function(x) {
#     apply(x, 1, function(x) any(x == 1))
# }
# 
# m_i <- c(0, sapply(3:6, function(x) 
#   sum(detected_before(dat2[dat2[, x] == 1, 2:(x-1)]))))
# 
# schnabel(catch = n_i, recaps = m_i, newmarks = n_i - m_i)
# ```
# 
# ------------------------------------------------------------------------
# 
# ### Überlegen Sie
# 
# Was ist der Vorteil des Schnabel Schätzer gegenüber dem Lincoln-Petersen Schätzer?
# 
# Der Schnabel Schätzer ist ...
# 
# 1.  ... schneller zu berechnen, weil es ein R Paket gibt.
# 2.  ... genauer, weil es ein R Paket gibt.
# 3.  ... genauer, weil man $>2$ Fangereignisse berücksichtigen kann.
# 4.  ... genauer, weil man genau 5 Fangereignisse berücksichtigen kann.
# 
# \pause
# 
# Die richtige Antwort ist 3.
# 
# Es besteht aber das gleiche Problem wie beim Lincoln-Petersen Schätzer: - nicht klar, welche Fläche beprobt wurde - ignorieren jeglichen Raum, also wo der Fang-Wiederfang stattgefunden hat - berücksichtigen nur den Wiederfang
# 
# ------------------------------------------------------------------------
# 
# ### Annahmen
...
#     -   Der 2. Fang kann rein visuell sein (z.B. Skalski *et al.* 2005[^s10-abundance2-1], Ohrmarken bei Rothirschen).
# 
# [^s10-abundance2-1]: Skalski, J. R., Millspaugh, J. J., & Spencer, R. D. (2005). Population estimation and biases in paintball, mark–resight surveys of elk. Journal of Wildlife Management, 69(3), 1043-1052.
# 
# ------------------------------------------------------------------------
# 
...
# ## Modelle
# 
# ```{r, echo = FALSE, out.width="35%", fig.cap="Nach Otis et al. 1978"}
# knitr::include_graphics(here::here("img/otis.jpg"))
# 
# ```
# 
# -   **t**ime (Zeit): Ändert sich die Fangwahrscheinlichkeit über die Zeit?
# 
# ------------------------------------------------------------------------
# 
# -   **b**ehaviour (Verhalten): Ändert sich die Fangwahrscheinlichkeit mit dem Verhalten (z.B. durch vorherige Fänge)?
# -   **h**eterogeneous (Individum): Haben unterschiedliche Individuen eine unterschiedliche Fangwahrscheinlichkeit (z.B. wegen ihrem Streifgebiet)?
# 
# ------------------------------------------------------------------------
# 
# Anpassen unterschiedlicher Modelle in R:
# 
# ```{r}
# library(Rcapture)
# m <- closedp(dat2[, -1])
# ```
# 
# Welches Modell sollen wir jetzt berücksichtigen?
# 
# ------------------------------------------------------------------------
# 
# ```{r}
# m$results %>% as.data.frame() %>% 
#   filter(infoFit == 0) %>% 
#   arrange(AIC) %>% 
#   dplyr::select(abundance, stderr, AIC)
# ```
# 
# ------------------------------------------------------------------------
# 
# ### Überlegen Sie:
# 
# Sie haben eine Tierart, bei der nach dem ersten Fangereignis einige Individuen Fallen meiden. Welches Model könnte am besten passen?
# 
# 1.  $M_0$
# 2.  $M_t$
# 3.  $M_b$
...
# 
# ```{r, echo = FALSE, fig.cap="Angepasst von Royle et al. 2020"}
# knitr::include_graphics(here::here("img/royle1.png"))
# ```
# 
# ------------------------------------------------------------------------
# 
# ```{r, echo = FALSE, fig.cap="Angepasst von Royle et al. 2020"}
# knitr::include_graphics(here::here("img/royle2.png"))
# ```
# 
# ------------------------------------------------------------------------
# 
...
# 
# ```{r, echo = FALSE, fig.cap="Angepasst von Royle et al. 2020"}
# knitr::include_graphics(here::here("img/royle3.png"))
# ```
# 
# ------------------------------------------------------------------------
# 
...
# knitr::include_graphics(here::here("img/oscr.png"))
# ```
# 
# ------------------------------------------------------------------------
# 
...
# ## Bis zur nächsten Woche
# 
# Hören Sie Folge #78 des JAGDcasts zum Thema Lebensraumzerschneidung und Inzucht bei Wildtieren (https://www.podcast.de/episode/623730239/jagdcast-78-lebensraumzerschneidung-und-inzucht-bei-wildtieren). 
# 
# Überlegen Sie sich eine kurze Antwort zu folgenden Fragen:
# 
# 1. Was ist die effektive Populationsgröße.
# 2. Wieso ist die Vernetzung zwischen Populationen wichtig?
# 3. Was kann ein Problem bei Grünbrücken sein?
# 4. Was ist eine Art?